        ...
        <footer className="text-white bg-odgreen body-font">
          <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
            <span className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900" onClick={this.props.scrollToTop} style={{ cursor: 'pointer'}}>
              <svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 407.66 425.89" stroke="transparent" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0" className="w-12 h-12 text-white p-2 bg-litegreen fill-odgreen rounded-lg">
            ...
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
              ...
              <a href="https://business.google.com/n/3308618090331569903/searchprofile?hl=en-US" target="_blank" rel="noreferrer" className="text-gray-500">
                <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-8 h-8 pb-2 ml-1" viewBox="0 0 56.6934 56.6934">
